...
public final class ApiEndpoints {
    public static final String LINK_VERIFY = "/minecraft/link/verify";
    public static final String UNLINK = "/minecraft/unlink";
    public static final String CATCHES = "/minecraft/catches";
    public static final String CATCHES_REMOVE = "/minecraft/catches/remove";
